...
class CoreDataModel {
    ...
    var favoriteLeagueList = [FavoriteModel]()
    ...
    func gitAllData() -> [FavoriteModel]{
        ...
        for index in 0..<favoriteLeagueObject.count{
            ...
            let league = FavoriteModel(id: id, name: name, image: image, youtubeUrl: youtubeUrl)
    ...
    func addLeague(league: FavoriteModel){
